...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// F_1
			// 
			this->F_1->HeaderText = L"function";
			this->F_1->MinimumWidth = 6;
			this->F_1->Name = L"function";
			this->F_1->ReadOnly = true;
			this->F_1->Width = 120;
			// 
			// F_2
			// 
			this->F_2->HeaderText = L"NM function";
			this->F_2->MinimumWidth = 6;
			this->F_2->Name = L"NM function";
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(574, 485);
			...
			this->label6->Location = System::Drawing::Point(550, 488);
